...
def plot_kline_volume_signal(data, name, buy_sell) -> Grid:
    ...
    kline = (
        ...
        Kline(init_opts=opts.InitOpts(width="1350px", height="750px"))
        ...
        .add_yaxis(
            ...
            # itemstyle_opts=opts.ItemStyleOpts(color="#FF003D", color0="#009933"),
        )
        .set_global_opts(legend_opts=opts.LegendOpts(is_show=True, pos_bottom=10, pos_left="center", orient='horizontal'),
                         datazoom_opts=[
                             opts.DataZoomOpts(
                                 is_show=False,
                                 type_="inside",
